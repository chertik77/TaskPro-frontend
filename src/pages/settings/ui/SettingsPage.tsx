    ...
    <div className='flex items-center gap-6'>
      <div
        className='border-brand bg-white-soft dark:border-brand/50 h-full w-65
          border border-b-0 border-l-0 py-20 pl-6 dark:bg-black'>
          ...
          {MENU_DATA.map(({ name, icon: Icon, href }) => (
            <li key={name}>
              <button
                ...
                className='hocus:text-black dark:hocus:text-white flex w-full
                  items-center gap-2 py-2 text-black/50 transition-colors
                  dark:text-white/50'>
