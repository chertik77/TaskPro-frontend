  ...
  return (
    ...
    violet:bg-gray-secondary dark:bg-black-third tablet:h-[272px] tablet:p-5 desktop:mx-6'>
      ...
      <div className='flex items-center gap-2'>
        <Button
          onClick={open}
          className='mb-4 hocus:text-brand-hover  violet:text-white violet:hocus:text-brand-third dark:text-white-primary dark:hocus:text-brand-hover'
          isSmallIcon
          iconName='help'>
          <span className='text-fs-12-lh-normal-fw-400 violet:text-white violet:hocus:text-brand-third dark:text-white dark:hocus:text-brand-hover'>
            Need help?
          </span>
        </Button>
      </div>
