    ...
    <label
      ...
      <div
        ...
        <input
          ...
          ref={ref}
        />
        <div className='size-[90%] rounded-[50%] border-[3px] border-white opacity-0 transition duration-300 ease-in-out peer-checked:opacity-100 data-[state=checked]:opacity-100 dark:border-black'></div>
      </div>
      {isValue && (
        <button
          type='button'
